    ...
    <div className="page-enter">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-end', gap: 24, marginBottom: 8 }}>
            {podium.map((u, i) => (
              <div key={u.id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, maxWidth: 150 }}>
                <UserAvatar name={u.displayName} color={u.avatarColor} size={podiumAvatarSizes[i]} avatarType={u.avatarType as any} avatarPreset={u.avatarPreset} avatarPhotoUrl={u.avatarPhotoUrl} />
      ...
      {sorted.map((u, i) => (
        <div key={u.id} className="tq-card" style={{
          ...
          <UserAvatar name={u.displayName} color={u.avatarColor} size={56} avatarType={u.avatarType as any} avatarPreset={u.avatarPreset} avatarPhotoUrl={u.avatarPhotoUrl} />
          <div style={{ flex: 1 }}>
